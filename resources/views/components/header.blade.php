                ...
                @else
                    ...
                    <li class="nav-item dropdown ml-2">
                        ...
                        <div id="dropdownMenu"
                            ...
                            style="position: absolute;left: -20px;width: 11rem; display: none;"
                            aria-labelledby="navbarDropdown">
                            <div class="py-1" role="none">
                                <div class="dropdown-item-text px-2 py-2">
                                ...
                                <a class="dropdown-item px-2 py-2" href="{{ route('mypage.bought-items') }}">
                                    <i class="fas fa-shopping-bag text-left" style="width: 30px"></i>購入した商品
                                </a>
                                <a class=" px-2 py-2 dropdown-item" role="menuitem"
                                    href="{{ route('mypage.edit-profile') }}">
                                    <i class="far fa-address-card text-left" style="width: 30px;"></i> プロフィール編集
                                </a>

                                <a class="px-2 py-2 dropdown-item" role="menuitem" href="{{ route('logout') }}"
